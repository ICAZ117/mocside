<template>
<div class="work-area">
    <div class="editor row" style="padding: 0 !important; background-color: rgb(58, 58, 58)">
        <v-ace-editor class="editor" v-model:value="content" :lang="editorLangauge" :theme="theme" />
